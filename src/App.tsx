...
const AddCustomerPage = lazy(() => import("./pages/dashboard/customers/AddCustomerPage"));
const EditCustomerPage = lazy(() => import("./pages/dashboard/customers/EditCustomerPage"));
