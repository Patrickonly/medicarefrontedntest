              ...
              <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    type="text"
                    maxLength={6}
                    className="h-14 w-full rounded-[1.2rem] border border-border bg-card px-6 text-center text-2xl font-extrabold tracking-[0.5em] text-[#09111f] outline-none transition placeholder:text-[#9badbd] placeholder:tracking-normal focus:border-[#0aa9ad] focus:ring-4 focus:ring-[#0aa9ad]/10"
                    placeholder="000000"
                    value={code}
